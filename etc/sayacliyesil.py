...
while capture.isOpened():
      ...
      filtered= cv2.GaussianBlur(dilation,(11,11),cv2.BORDER_DEFAULT)
      ret,thresh = cv2.threshold(filtered,240,255,cv2.THRESH_BINARY) #En beyazi 255 kadar olsun , 190 dan kucukler gozukmesin
